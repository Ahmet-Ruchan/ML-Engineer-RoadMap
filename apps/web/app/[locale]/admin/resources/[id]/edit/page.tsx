...
export default function EditResourcePage() {
      ...
      if (data.success) {
        ...
        if (resource) {
          setFormData({
            ...
            titleTr: resource.titleTr,
            descriptionEn: resource.descriptionEn || '',
            descriptionTr: resource.descriptionTr || '',
            type: resource.type,
            url: resource.url,
  ...
  if (loading) {
    return <div className="text-center py-20">Loading resource...</div>
  }

  return (
    <div>
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-2">Edit Resource</h1>
